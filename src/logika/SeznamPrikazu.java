 ...
 * 
 * Používá se pro rozpoznávání příkazů a vrácení odkazu na třídu implementující
 * konkrétní příkaz. Každý nový příkaz (instance implementující rozhraní Prikaz)
 * se musí do seznamu přidat metodou vlozPrikaz.
 * 
...
class SeznamPrikazu {
    ...
    /**
     * Vrací seznam přípustných příkazů, jednotlivé příkazy jsou odděleny
     * mezerou.
     * 
